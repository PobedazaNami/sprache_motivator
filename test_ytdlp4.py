"""Test: yt-dlp subtitle extraction via Python API (ignore format errors)."""
import json
import shutil
import yt_dlp
import os
...
print(f"\nManual subs langs: {list(subs.keys())[:10]}")
print(f"Auto caption langs: {list(auto_subs.keys())[:10]}")
